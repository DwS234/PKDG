        ...
        <div className="border-b border-black last:border-b-0 mb-2 pb-2 last:pb-0" key={repetitionWithWord.repetition.repetitionId}>
          ...
          <div>
            ...
            <div className="w-48 bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
              <div className="bg-blue-600 h-2.5 rounded-full" style={{width: `${Math.round((repetitionWithWord.repetition.easiness * 100) / 2.5)}%`}}></div>
              </div>
          </div>
        </div>
      ))}
