...
const WordPopup = ({ open, onClose, words, wordsInRepetitionProp, username }: WordPopupProps) => {
	...
	return (
		<>
			<div
				tabIndex={-1}
				className="hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full flex justify-center"
				id={modalId}
			>
				<div className="relative mt-10 mb-10 max-w-4xl h-full md:h-auto overflow-y-auto overflow-x-hidden">
					<div className="relative bg-white shadow dark:bg-gray-700">
						...
						<div className="p-6 space-y-6 pl-12 pr-12">{prepareWordsView()}</div>
					</div>
				</div>
			</div>
		</>
